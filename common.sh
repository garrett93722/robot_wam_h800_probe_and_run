...
load_config() {
  ...
  local ENV_SOURCE_ROOT="${SOURCE_ROOT-}"
  local ENV_LOG_DIR="${LOG_DIR-}"
  local ENV_LINGBOT_REPO="${LINGBOT_REPO-}"
  local ENV_DREAMZERO_REPO="${DREAMZERO_REPO-}"
  local ENV_LIBERO_REPO="${LIBERO_REPO-}"
  local ENV_LINGBOT_ENV_NAME="${LINGBOT_ENV_NAME-}"
  local ENV_DREAMZERO_ENV_NAME="${DREAMZERO_ENV_NAME-}"
  local ENV_LIBERO_ENV_NAME="${LIBERO_ENV_NAME-}"
  local ENV_LINGBOT_CKPT_DIR="${LINGBOT_CKPT_DIR-}"
  local ENV_DREAMZERO_CKPT_DIR="${DREAMZERO_CKPT_DIR-}"
  local ENV_DREAMZERO_AGIBOT_CKPT_DIR="${DREAMZERO_AGIBOT_CKPT_DIR-}"
  local ENV_LIBERO_DATA_DIR="${LIBERO_DATA_DIR-}"
  local ENV_CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES-}"
  local ENV_DREAMZERO_CUDA_VISIBLE_DEVICES="${DREAMZERO_CUDA_VISIBLE_DEVICES-}"
  ...
  [[ -n "${ENV_SOURCE_ROOT}" ]] && SOURCE_ROOT="${ENV_SOURCE_ROOT}"
  [[ -n "${ENV_LOG_DIR}" ]] && LOG_DIR="${ENV_LOG_DIR}"
  [[ -n "${ENV_LINGBOT_REPO}" ]] && LINGBOT_REPO="${ENV_LINGBOT_REPO}"
  [[ -n "${ENV_DREAMZERO_REPO}" ]] && DREAMZERO_REPO="${ENV_DREAMZERO_REPO}"
  [[ -n "${ENV_LIBERO_REPO}" ]] && LIBERO_REPO="${ENV_LIBERO_REPO}"
  [[ -n "${ENV_LINGBOT_ENV_NAME}" ]] && LINGBOT_ENV_NAME="${ENV_LINGBOT_ENV_NAME}"
  [[ -n "${ENV_DREAMZERO_ENV_NAME}" ]] && DREAMZERO_ENV_NAME="${ENV_DREAMZERO_ENV_NAME}"
  [[ -n "${ENV_LIBERO_ENV_NAME}" ]] && LIBERO_ENV_NAME="${ENV_LIBERO_ENV_NAME}"
  [[ -n "${ENV_LINGBOT_CKPT_DIR}" ]] && LINGBOT_CKPT_DIR="${ENV_LINGBOT_CKPT_DIR}"
  [[ -n "${ENV_DREAMZERO_CKPT_DIR}" ]] && DREAMZERO_CKPT_DIR="${ENV_DREAMZERO_CKPT_DIR}"
  [[ -n "${ENV_DREAMZERO_AGIBOT_CKPT_DIR}" ]] && DREAMZERO_AGIBOT_CKPT_DIR="${ENV_DREAMZERO_AGIBOT_CKPT_DIR}"
  [[ -n "${ENV_LIBERO_DATA_DIR}" ]] && LIBERO_DATA_DIR="${ENV_LIBERO_DATA_DIR}"
  [[ -n "${ENV_CUDA_VISIBLE_DEVICES}" ]] && CUDA_VISIBLE_DEVICES="${ENV_CUDA_VISIBLE_DEVICES}"
  [[ -n "${ENV_DREAMZERO_CUDA_VISIBLE_DEVICES}" ]] && DREAMZERO_CUDA_VISIBLE_DEVICES="${ENV_DREAMZERO_CUDA_VISIBLE_DEVICES}"
